...
author:
  - Alexandre Freitas
  - João Vitor Leite Rodrigues
date: '2021-08-09'
summary: "Quem são? Quantos são? Qual o perfil dos jovens petistas eleitos nessa última candidatura? Uma análise do resultado da JPT nas eleições de 2020"
output: 
  html_document:
    code_folding: hide
editor_options: 
...
```{r Biblioteca, message=FALSE, warning=FALSE, echo = FALSE}
...
Autores: Alexandre Freitas^[Militante da Juventude do PT de Belo Horizonte / MG, alexandrefreitas92@gmail.com] e João Vitor Leite Rodrigues^[Militante da Juventude do PT de Belo Horizonte / MG, jvleiterodrigues@gmail.com].
...
Acesse a lista com a votação de todas as candidaturas jovens do PT em https://www.alexandremfreitas.com/pt/post/analise_eleicoes/produtos/tabela_juventude_eleitos_pt.html
...
t_vereadores_jovens_pt <- DT::datatable(vereadores_jovens_pt,
          filter = 'top',
